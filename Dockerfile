cd /d "D:\JONATHAN\Proyectos\Jht_Transport Company\Software\Front_jht\app_jht_front"

# 1. Elimina el Dockerfile actual
del Dockerfile

# 2. Crea nuevo con PowerShell
@'
...
COPY --chown=flutteruser:flutteruser assets/ ./assets/ 2>/dev/null || true
